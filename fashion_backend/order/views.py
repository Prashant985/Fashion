        ...
        try:
            with transaction.atomic():
                ...
                for product_data in data['order_products']:
                    ...
                    message = 'Your payment has been succesfully and your order has been succesfully placed';
            ...
            return Response({'message':'User address does not exists'}, status=status.HTTP_404_NOT_FOUND)
